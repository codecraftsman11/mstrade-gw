...
class BinanceRestApi(StockRestApi):
    ...
    def get_wallet_detail(self, schema: str, asset: str, **kwargs) -> dict:
        schema_handlers = {
            ...
            OrderSchema.margin2: (self._handler.get_margin_account, utils.load_margin_wallet_detail_data),
    ...
    def get_liquidation(
        ...
        **kwargs,
        ...
        contract_size = symbol_state_data.get('extra_params', {}).get('face_price_data', {}).get('contract_size')
