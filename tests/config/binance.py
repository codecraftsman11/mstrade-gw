...
BINANCE_SPOT_WSS_API_URL = getenv(
    "BINANCE_SPOT_WSS_API_URL", "wss://stream.binance.com:9443/ws"
)
BINANCE_FUTURES_WSS_API_URL = getenv(
    "BINANCE_FUTURES_WSS_API_URL", "wss://fstream.binance.com/ws"
)
BINANCE_AUTH_KEYS = {
...
BINANCE_SPOT_TESTNET_WSS_API_URL = getenv(
    "BINANCE_SPOT_TESTNET_WSS_API_URL", "wss://testnet.binance.vision/ws"
)
...
BINANCE_FUTURES_TESTNET_WSS_API_URL = getenv(
    "BINANCE_FUTURES_TESTNET_WSS_API_URL", "wss://stream.binancefuture.com/ws"
)
