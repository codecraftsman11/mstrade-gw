...
BINANCE_SPOT_TESTNET_WSS_API_URL = getenv('GW_BINANCE_SPOT_TESTNET_WSS_API_URL',
...
BINANCE_FUTURES_TESTNET_WSS_API_URL = getenv('GW_BINANCE_FUTURES_TESTNET_WSS_API_URL',
                                             'wss://stream.binancefuture.com/ws')
BINANCE_FUTURES_COIN_TESTNET_WSS_API_URL = getenv('GW_BINANCE_FUTURES_COIN_TESTNET_WSS_API_URL',
