...
DEFAULT_LEVERAGE_BRACKETS = {
    OrderSchema.margin: {
        'btcusdt': [{'bracket': 1, 'initial_leverage': 25.0, 'notional_cap': 50000.0, 'notional_floor': 0.0,
        ...
        'xrpusdt': [{'bracket': 1, 'initial_leverage': 75.0, 'notional_cap': 10000.0, 'notional_floor': 0.0,
        ...
        'ltcusdt': [{'bracket': 1, 'initial_leverage': 75.0, 'notional_cap': 10000.0, 'notional_floor': 0.0,
                     'maint_margin_ratio': 0.0065, 'cum': 0.0},
                    {'bracket': 2, 'initial_leverage': 50.0, 'notional_cap': 50000.0, 'notional_floor': 10000.0,
                     'maint_margin_ratio': 0.01, 'cum': 35.0},
                    {'bracket': 3, 'initial_leverage': 25.0, 'notional_cap': 250000.0, 'notional_floor': 50000.0,
    ...
    OrderSchema.margin_coin: {
        'btcusd_perp': [
            {'bracket': 1, 'initial_leverage': 125.0, 'qty_cap': 5.0, 'qty_floor': 0.0, 'maint_margin_ratio': 0.004,
             'cum': 0.0},
            {'bracket': 2, 'initial_leverage': 100.0, 'qty_cap': 10.0, 'qty_floor': 5.0, 'maint_margin_ratio': 0.005,
             'cum': 0.005},
            {'bracket': 3, 'initial_leverage': 50.0, 'qty_cap': 20.0, 'qty_floor': 10.0, 'maint_margin_ratio': 0.01,
             'cum': 0.055},
            {'bracket': 4, 'initial_leverage': 20.0, 'qty_cap': 50.0, 'qty_floor': 20.0, 'maint_margin_ratio': 0.025,
             'cum': 0.355},
            {'bracket': 5, 'initial_leverage': 10.0, 'qty_cap': 100.0, 'qty_floor': 50.0, 'maint_margin_ratio': 0.05,
             'cum': 1.605},
            {'bracket': 6, 'initial_leverage': 5.0, 'qty_cap': 200.0, 'qty_floor': 100.0, 'maint_margin_ratio': 0.1,
             'cum': 6.605},
            {'bracket': 7, 'initial_leverage': 4.0, 'qty_cap': 400.0, 'qty_floor': 200.0, 'maint_margin_ratio': 0.125,
             'cum': 11.605},
            {'bracket': 8, 'initial_leverage': 3.0, 'qty_cap': 1000.0, 'qty_floor': 400.0, 'maint_margin_ratio': 0.15,
             'cum': 21.605},
            {'bracket': 9, 'initial_leverage': 2.0, 'qty_cap': 1500.0, 'qty_floor': 1000.0, 'maint_margin_ratio': 0.25,
             'cum': 121.605},
            {'bracket': 10, 'initial_leverage': 1.0, 'qty_cap': 9.223372036854776e+18, 'qty_floor': 1500.0,
             'maint_margin_ratio': 0.5, 'cum': 496.605}],
        'xrpusd_perp': [
            {'bracket': 1, 'initial_leverage': 20.0, 'qty_cap': 500000.0, 'qty_floor': 0.0, 'maint_margin_ratio': 0.023,
             'cum': 0.0}, {'bracket': 2, 'initial_leverage': 10.0, 'qty_cap': 1000000.0, 'qty_floor': 500000.0,
        ...
        'ltcusd_perp': [
            {'bracket': 1, 'initial_leverage': 20.0, 'qty_cap': 5000.0, 'qty_floor': 0.0, 'maint_margin_ratio': 0.023,
             'cum': 0.0}, {'bracket': 2, 'initial_leverage': 10.0, 'qty_cap': 10000.0, 'qty_floor': 5000.0,
                ...
                'd': [
                    {
                        ...
                        'vt': 1e-06,
                        'ss': 'btcusdt',
                        'crt': '2022-06-30T08:39:27.575230',
                        'mlvr': None,
                        'wa': None,
                        'fr': None
                    }
                ...
                'd': [
                    {
                        ...
                        'vt': 0.001,
                        'ss': 'btcusdt',
                        'crt': '2022-06-30T08:39:27.576033',
                        'mlvr': 25.0,
                        'wa': 'USDT',
                        'fr': 0.0
                    }
                ...
                'd': [
                    {
                        ...
                        'vt': 1.0,
                        'ss': 'btcusd',
                        'crt': '2022-08-02T13:21:45.703245',
                        'mlvr': 125.0,
                        'wa': 'BTC',
                        'fr': 0.0
                    }
